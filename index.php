  ...
  <div id="header">
    <div id="new-header-content">
	  <div style="position: relative;">
	    <img style="float:left; margin:0px; padding:0px;float: left" id="imagebanner" alt="Header" src="/images/header.jpg"/>
	  </div> 
    </div> 
  </div>
  ...
  <div id="wrapper2">
    <div id="wrapper">
			  ...
			  <div id="body-content" style="border-left:1px solid gray; padding-left: 4px;" >
				<br/><br/>
				<strong>Databib is currently being beta-tested.</strong> Please e-mail <a href="mailto:databib@gmail.com">databib@gmail.com</a> to report any bugs or give feedback.
				<p>&nbsp;</p>
				<hr />
				<p>&nbsp;</p>
								...
								<form name="search_bar" method="get" action="search_results.php">
										<div style="width:700px; cellpadding:15px;">
											...
											<input type="text" name="query" style="width:300px; height:22px;" autofocus> </input> 
											&nbsp;&nbsp;
