...
$authority_id = mysql_real_escape_string($_GET['authorityid']);	

$cat = mysql_fetch_row(mysql_query("SELECT auth_name FROM authorities WHERE id_authority = $authority_id")); 
...
<!--         <a href="advanced_search.php"> Advanced Search</a> -->
   ...
   <h1>Browse <?php echo $cat[0]; ?></h1>
	...
	<?php 
		...
		$results = mysql_query("SELECT a.rep_title, a.id_rep FROM approved a, approved_authorities t WHERE t.id_authority = $authority_id AND t.id_record = a.id_rep ORDER BY a.rep_title"); 
