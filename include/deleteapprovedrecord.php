      ...
      <div id="body-content">
        ...
        <div id='fg_membersite_content'>
		 <?php
			...
			{
					echo "Only administrator has permission to delete";
			}
			else
			{
					$record_id = mysql_real_escape_string(@$_REQUEST['record']);
					$query = "delete from approved where id_record =  $record_id";
					mysql_query($query) or 	die(mysql_error());
					
					echo " The record has been deleted from the database.";
			}
		 ?>
		<br/><br/><br/>
		</div>
